...
view(filter(NLA_states_excel, State %in% c("Connecticut", "Maine", "Massachusetts", "New Hampshire", "New York", "New Jersey", "Pennsylvania", "Rhode Island", "Vermont")))
```

```{r plotting NE_NLA}
NE_NLA <- dplyr::filter(NLA_states_excel, State %in% c("Connecticut", "Maine", "Massachusetts", "New Hampshire", "New York", "New Jersey", "Pennsylvania", "Rhode Island", "Vermont"))
