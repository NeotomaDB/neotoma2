...
pc_abun <- function(dl_object) {
  ...
  countDF <- data.frame(lat, long, siteid, datasetid, sampleid, taxa, count) %>%
    group_by(sampleid) %>%
...
diat_9_new <- c(44830,44831,44832,44833,44834,44835,44836,44837,44838,44839,44840,44841,44842,44843,44844,44845,44846,44847,44848,44849,44850,44851,44852,44853,44854,44855,44856,44857,44859,44860,44861,44862,44863,44864,44865,44866,44867,44868,44869,44870,44871,44872,44873,44874,44875,44876,44877,44878,44879,44880,44881,44882,44883,44884,44885,44886,44887,44888,44889,44890,44891,44892)
#############################################################################
...
phos_vs_abun <- plot(x_phos,y_abun,
   ...
   ylab = "% Abundance",
   main = "Total Phosphorus vs. Eunotia exigua % Abundance")

x_phos_no_190 <- x_phos[-16]
y_abun_no_190 <- y_abun[-16]

eye2 <- plot(x_phos_no_190, y_abun_no_190, xlab = "Total Phosphorus (µg/L)", ylab = "% Abundance", main = "Total Phosphorus vs. Eunotia exigua % Abundance")
