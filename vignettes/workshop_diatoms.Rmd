...
Some examples of helper functions are `datasets()`, `collunits()`, `samples()`,`taxa()`, and `coordinates()`. These are listed and described within the `neotoma2` package documentation. Below are some basic examples of the output of first three of the functions listed above.
...
Use the `datasets()` function to get a simple table with a subset of basic dataset information. The following code is an example of how to convert the object to a dataframe for manipulation.
