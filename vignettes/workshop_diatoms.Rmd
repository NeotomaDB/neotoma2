...
The functions used to extract elements from `sites objects` may not always have all the variables of interest, or too many variables. Custom tables, or data frames, can be made. The following example creates a table containing siteid, sitename, collection unit id, datasetid, datasettype, age_range_old, age_range_ young, and first publication.
