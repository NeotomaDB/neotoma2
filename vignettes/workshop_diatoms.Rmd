...
Some examples of helper functions are `datasets()`, `collunits()`, `samples()`,`taxa()`, `coordinates`, and many others that are listed within the `neotoma2` package documentation. Below, we will show some basic examples of the output of first three of the functions listed above.
...
#### `plotLeaflet()` functions

The `neotoma2` page has a function to map a `sites` object
