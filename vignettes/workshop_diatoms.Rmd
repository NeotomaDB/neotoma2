...
##### Diatom counts and water chemistry, combined
...
SIMON and SOCCORO - the following code works, but times-out before all diatom taxa are returned.  Please fix.
...
SIMON and SOCORRO - The bounding box argument does not work in the example below.  Sites are returned that are located outside the box.
...
Wish list for additional types of maps:
...
NEED INSTRUCTIONS/ CODE for creating input files and creating a variety of stratigraphic diagrams.  Advantages and disadvantages various packages.  Include an example here? TidyPaleo example?
