...
JERRIN - Who prepared this code?  What is "Subset"?
```{R ExampleSingleSite }
Alexander<- get_dataset(24) # Dataset ID for Alex. Lake is 24
subsetda <- sapply(Alexander, 
                 function(x) {
                   x$dataset.meta$dataset.id 
                   })
# In the subset it would run the dataset and search for the parameters by the use of dollar signs JERRIN - is this a filter or select function
