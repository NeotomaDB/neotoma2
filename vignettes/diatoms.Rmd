...
library(neotoma)
# The get_site function (Neotoma R) can process only one lake at a time.  This code chunk retrieves data for multiple lakes.  It was created by Soccorro Dominguez.  The get_sites function being developed in Neotoma2 may allow processing of multiple sites.
...
#duplicate is in line 335 for water chem 
