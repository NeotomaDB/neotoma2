...
## Find diatom datasets using one or more search criteria. General task specification format: “ “Find all diatom datasets that” meet the following criteria.”  [Followed by code specifying how to search / filter by this criterion] 
