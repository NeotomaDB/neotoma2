...
#In this chunk I envision that we will use the metadata from the chronology or age depths to figure this out 
...
library(neotoma)
library(neotoma2)
aggr_set <- read.csv()# So if we are going to use the excel fi;e we should read it here and tham could use it to find information
<- get_datasets()
<- get_download()
...
### Site info:
#### Neotoma Site ID
, Site name, Latitude, Longitude, Latitude width, Longitude width, Country, State, County, Admin Unit (3rd Geographic Unit), Lake characteristics
