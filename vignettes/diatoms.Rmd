...
# An example showing how to get multiple site ID that match with diatom surface samples 
#A current error will have to do with null altitudes so some may not work 
```
### Dataset ID
...
if('UWall' %in% list.files()) {
  ...
  UWallf_dl <- get_download(subsetSchr)
