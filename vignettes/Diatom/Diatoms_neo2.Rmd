...
The following code gets a complete list of diatom taxa name variables from the Neotoma Taxa table.
...
**Values returned:** A "publications" object and a table that displays the variables publicationid, citation, and DOI. The "publications" object contains all possible publication information.
