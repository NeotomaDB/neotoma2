...
```{r NLAmultiplesiteID}
nlad <- read.table('vignettes\\Data-DFC\\NLAD.txt', header=FALSE)
...
Example of obtaining diatom counts for an aggregate dataset by reading an external file with datasetids.

```{R aggregate dataset finding taxa}
