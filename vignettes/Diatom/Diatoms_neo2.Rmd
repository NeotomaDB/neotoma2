...
Get all datasets for "diatom", "diatom top-bottom", "diatom surface sample."

```{r multi datasettype}

diatom_list <- c("diatom", "diatom top-bottom", "diatom surface sample", "diatom bottom sample")
data_all_diat <- c()
...
**Values returned:** A "publications" object and a table [dataframe?] that displays the variables publicationid, citation, and DOI. The "publications" object contains all possible publication information.
