...
There should only be 1 plotting taxa (instead of 4) **DONE**. Makes use of a modified PlotLeaflet function in neotoma2 that I named PlotLeaflet2. This function is not in the document, but it is a separate script I have locally (add?). Extra code needs to be removed. Remove all variable naming (use %>%). 
...
# Making a leaflet map for different datasets in aggregate datasets
...
END OF "Making a leaflet map for different datasets in aggregate datasets"
