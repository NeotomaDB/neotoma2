...
#'
#' @description Functions \code{\link{get_sites}}, \code{\link{get_datasets}} need passed arguments to be checked. \code{param_check} tells them if there's a problem.
#' @param cl called arguments. 
#'    Arguments are going to be called by match_call inside \code{\link{get_sites}} or \code{\link{get_datasets}}
